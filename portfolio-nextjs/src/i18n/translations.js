...
export const translations = {
    it: {
        ...
        locations: {
            ...
            copenhagenDenmark: 'Copenaghen, Danimarca',
            frankfurtGermany: 'Francoforte, Germania',
            munsterGermany: 'Münster, Germania',
            hamburgGermany: 'Amburgo, Germania',
            bonnGermany: 'Bonn, Germania',
        },
        languageNames: {
            it: 'Italiano',
            en: 'Inglese',
    ...
    en: {
        ...
        locations: {
            ...
            copenhagenDenmark: 'Copenhagen, Denmark',
            frankfurtGermany: 'Frankfurt, Germany',
            munsterGermany: 'Münster, Germany',
            hamburgGermany: 'Hamburg, Germany',
            bonnGermany: 'Bonn, Germany',
        },
        languageNames: {
            it: 'Italian',
            en: 'English',
    ...
    de: {
        ...
        locations: {
            ...
            hangzhouChina: 'Hangzhou, Zhejiang, China',
            copenhagenDenmark: 'Kopenhagen, Dänemark',
            frankfurtGermany: 'Frankfurt, Deutschland',
            munsterGermany: 'Münster, Deutschland',
            hamburgGermany: 'Hamburg, Deutschland',
            bonnGermany: 'Bonn, Deutschland',
        },
        languageNames: {
            it: 'Italienisch',
            en: 'Englisch',
    ...
    fr: {
        ...
        locations: {
            ...
            copenhagenDenmark: 'Copenhague, Danemark',
            frankfurtGermany: 'Francfort, Allemagne',
            munsterGermany: 'Münster, Allemagne',
            hamburgGermany: 'Hambourg, Allemagne',
            bonnGermany: 'Bonn, Allemagne',
        },
        languageNames: {
            it: 'Italien',
            en: 'Anglais',
    ...
    es: {
        ...
        locations: {
            ...
            hangzhouChina: 'Hangzhou, Zhejiang, China',
            copenhagenDenmark: 'Copenhague, Dinamarca',
            frankfurtGermany: 'Fráncfort, Alemania',
            munsterGermany: 'Münster, Alemania',
            hamburgGermany: 'Hamburgo, Alemania',
            bonnGermany: 'Bonn, Alemania',
        },
        languageNames: {
            it: 'Italiano',
            en: 'Inglés',
    ...
    da: {
        ...
        locations: {
            ...
            copenhagenDenmark: 'København, Danmark',
            frankfurtGermany: 'Frankfurt, Tyskland',
            munsterGermany: 'Münster, Tyskland',
            hamburgGermany: 'Hamborg, Tyskland',
            bonnGermany: 'Bonn, Tyskland',
        },
        languageNames: {
            it: 'Italiensk',
            en: 'Engelsk',
    ...
    zh: {
        ...
        locations: {
            ...
            copenhagenDenmark: '哥本哈根，丹麦',
            frankfurtGermany: '法兰克福，德国',
            munsterGermany: '明斯特，德国',
            hamburgGermany: '汉堡，德国',
            bonnGermany: '波恩，德国',
        },
        languageNames: {
            it: '意大利语',
